  ...
  return (
    <>
      <div className="bg-violet rounded-2xl px-10 py-10 w-60 sm:w-72 mx-16 sm:mx-16 md:mx-32 md:w-80 lg4:w-96 xl:min-w-full xl:min-h-full">
        <p className="font-bold mb-2 text-7xl lg:text-6xl cursor-auto">{activeCompany.name}</p>
        <p className="mb-1 text-lg">{activeCompany.position}</p>
        <p className="italic text-sm lg:text-7xl">
        {activeCompany.startDate} - {activeCompany.endDate ? activeCompany.endDate : 'Present'}
        </p>
